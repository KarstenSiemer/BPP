...
\begin{table}[h]
  ...
  \begin{tabular}{ |p{3cm}|p{6cm}|p{3cm}| }
      ...
      \hline
      \multirow{4}{*}{Konzeption}       &      DNS Hierarchie                       &    3               \\
                                        &      Security Öffentlich/Private Zonen    &    3               \\
                                        &      Security DNSSEC                      &    3               \\
                                        &      Infrastruktur Übersetzung            &    1               \\
      \hline
      ...
      \hline
      Test                              &      Testen der Erstellung                &    1               \\
                                        &      Testen der Erreichbarkeit            &    1               \\
      \hline
